...
public:
	...
	*/
	void createDescriptorSets()
	{
		...
		VkDescriptorSetAllocateInfo descriptorSetAllocateInfo = engine::initializers::descriptorSetAllocateInfo(vulkanDevice->m_descriptorPool, &descriptorSetLayout, 1);
