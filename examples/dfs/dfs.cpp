...
public:
	...
	{	
		setupDescriptorPool();
		plane.LoadGeometry(engine::tools::getAssetPath() + "models/plane.obj", &vertexLayout, 1.1f, 1);
	...
	virtual void update(float dt)
	{
		...
		uboCompute.triangleCount = model.m_geometries[0]->m_indexCount;//m_currentNoiseIndex;
