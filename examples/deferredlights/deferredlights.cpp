...
public:
	...
	void init()
	{
		...
		std::vector<render::MeshData*> emd = models.example.LoadGeometry(engine::tools::getAssetPath() + "models/armor/armor.dae", vertexLayoutInstanced, 0.3f, LIGHTS_NO, glm::vec3(0.0, 0.0, 0.0), glm::vec3(1.0, 1.0, 1.0), glm::vec2(1.0,-1.0));
