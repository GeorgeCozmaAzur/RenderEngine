...
namespace engine
{
	...
	{	
		...
		public:
			void Init(float innerRadius, float outerRadius, int resolution, render::VulkanDevice* vulkanDevice, render::VertexLayout* vertex_layout, render::VulkanBuffer* globalUniformBufferVS, std::vector<VkDescriptorImageInfo*> texturesDescriptors
