...
namespace engine
{
	namespace scene
	{
		...
		public:
			...
			void Init(render::VulkanBuffer *ub, render::VulkanDevice *device, VkDescriptorPool descriptorPool, VkQueue queue, VkRenderPass renderPass, VkPipelineCache pipelineCache, int lightsNumber,
