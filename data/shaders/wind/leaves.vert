...
void main() 
{
	...
	float wiggle = wiggle(uboModel.advance*0.1, 10, distfromcenterfactor) * 0.1;
	float finalwiggle = mix(0, wiggle, distfromcenterfactor);
	finalPos += uboModel.wind.xyz * finalwiggle;
